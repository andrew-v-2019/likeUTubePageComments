...
Друзья, если хотите немного повысить популярность ролика, вставьте скрипт в консоль браузера (в Chrome - клавиша F12, вкладка "консоль") и нажмите Enter. 
Скрипт ставит лайк под видео и под всеми комментариями от вашего имени. Можно запустить под всеми роликами Максометра! Пишите о результатах работы
